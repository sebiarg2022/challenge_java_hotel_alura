...
public class Busqueda extends JFrame {
	...
	//para la busqueda llenamos tabla completa
	...
	private void LlenarTablaHuespedes() {			       
		...
		try {
			for (Huesped huespedes : huesped) {
				modeloH.addRow(new Object[] { huespedes.getId(), huespedes.getNombre(), huespedes.getApellido(), huespedes.getFecha_nac(), huespedes.getNacionalidad(), huespedes.getTelefono(), huespedes.getId_reserva() });
			}
		} catch (Exception e) {
			throw e;
		}
	...
	private void ActualizarReservas() {		
        ...
        .ifPresentOrElse(fila -> {
			...
			this.reservaController.actualizar(fechaEntrada,fechaSalida, valor, forma_pago, id);
	...
	private void ActualizarHuesped() {		
        ...
        .ifPresentOrElse(filaHuesped -> {
        	...
        	Date fecha_nac = Date.valueOf(modeloH.getValueAt(tbHuespedes.getSelectedRow(), 3).toString());
			...
			this.huespedController.actualizar(nombre,apellido,fecha_nac, nacionalidad, telefono, id_reserva, id);
			JOptionPane.showMessageDialog(this, String.format("Registro modificado con éxito"));
		}, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un registro"));
