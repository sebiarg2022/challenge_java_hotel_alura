...
public class RegistroHuesped extends JFrame {
	...
	int xMouse, yMouse;
	int id; //id de la reserva que traemos declaramos un int

	//declaramos el controller huesped
	private HuespedController huespedController;
	//declaramos el controller reserva
	 ...
	 * Create the frame.
	 */
	//pasamos el id_reserva que hicimos al huesped
	public RegistroHuesped(int id) {
		
		//instanciamos huespedController que vamos a usar
				this.huespedController = new HuespedController();
		
				//instanciamos reservaController que tmb usamos para pasar el id_reserva
		...
		//pasamos el id de reserva que traemos
		//System.out.println(idReserva);
		//pasamos a una nueva var string el id que traemos entero a string
		String idReserva = String.valueOf(id);
		//colocamos en el txtNreserva
		txtNreserva.setText(idReserva);
		//ponemos el txt como disable para que no se pueda editar
	...
	/*		try {
				//transformamos la fecha en string, la que traemos de la view llamada 
				String fechaNac = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
				
				//pasamos al constructor de huesped los 6 valores
				...
				//llamamos al metodo controllerHuesped
				huespedController.guardar(huesped);
				JOptionPane.showMessageDialog(contentPane, "Huesped Registrado Exitosamente");
...
/*
    private void limpiarFormularioHuesped() {
        ...
        ((JTextField)txtFechaN.getDateEditor().getUiComponent()).setText("");
